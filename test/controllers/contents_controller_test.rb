...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { footer_copyright: @content.footer_copyright, homepage_heading_1: @content.homepage_heading_1, logo_image_path: @content.logo_image_path } }
    end
